...
1. ページの上部で **[管理]** を選択します。  新しいブラウザー タブが開き、[条件付きアクセス ポリシー] ページに直接移動します。  ブラウザーの [Microsoft セキュア スコア] タブに戻り、管理者ロールに対して MFA を必須にするための改善アクションのページに戻ります。 ウィンドウの右上隅で **[X]** を選択してこのウィンドウを閉じ、改善アクションのページに戻ります。
