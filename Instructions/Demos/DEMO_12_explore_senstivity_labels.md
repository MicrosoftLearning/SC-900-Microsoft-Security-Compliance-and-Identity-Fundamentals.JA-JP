...
#### <a name="demo-part-1-in-this-demo-you-show-the-settings-for-an-existing-sensitivity-label-and-the-corresponding-policy-to-publish-the-label"></a>デモ パート 1:このデモでは、既存の機密ラベルの設定と、ラベルを公開するための対応するポリシーについて説明します。
...
#### <a name="demo-part-2--in-this-step-you-will-show-the-process-of-applying-a-label-from-the-perspective-of-the-user-in-this-case-the-user-is-the-admin-and-view-the-content-marking-that-is-generated-by-the-label"></a>デモ パート 2:この手順では、ユーザー (この場合はユーザーが管理者) の観点からラベルを適用し、ラベルによって生成されたコンテンツ マーキングを表示するプロセスについて説明します。
