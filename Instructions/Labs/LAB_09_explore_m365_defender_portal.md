...
#### <a name="task-1--explore-the-microsoft-365-defender-landing-page"></a>タスク 1:Microsoft 365 Defender ポータルを詳細に確認します。
...
#### <a name="task-2-in-this-task-you-will-explore-how-microsoft-secure-score-can-help-an-organization-improve-its-security-posture"></a>タスク 2:このタスクでは、Microsoft Secure Score が組織のセキュリティ体制の改善にどのように役立つかを詳細に確認します。
