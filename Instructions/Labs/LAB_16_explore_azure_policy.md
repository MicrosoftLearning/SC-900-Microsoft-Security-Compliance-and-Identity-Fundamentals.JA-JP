...
1. [基本] タブから開始します。
    ...
    1. [ポリシーの適用] を必ず **[有効]** に設定し、 **[次へ]** を選択します。
...
1. ポリシーの割り当てを確認し、 **[作成]** を選択します。  ポリシーがすぐに表示されない場合は、**[更新]** を選択します。 注: ポリシーが有効になるまで最長 30 分かかる場合がありますが、通常はそれより早く有効になります。
...
1. [名前] フィールドに「**環境**」と入力し、[値] フィールドに「**ラボ**」と入力し (この値は何でもかまいません。ポリシーでは、タグ値が要求されているだけです)、 **[次へ: 確認と作成 >]** を選択し、 **[作成]** を選択します。
...
### <a name="task-3-optional"></a>タスク 3 (省略可能)
