...
6. 「新しいパスワード」フィールドに、「**SC900-Lab**」と入力します。  [パスワードの確認] フィールドに「SC900-Lab」と入力してから、[サインイン] を選択します。  注: ベスト プラクティスとして、より安全なパスワードを使用する必要があります。 このパスワードは便宜上、このラボの目的のためにのみ選択されています。
