...
lab:
  ...
  description: このラボでは、Microsoft Purview ポータルのホーム ページと、コンプライアンス マネージャーの機能が組織のコンプライアンス態勢の改善にどのように役立つかについて調べました。
  duration: 35 minutes
  level: 200
  islab: true
  primarytopics:
...
1. ランディング ページに情報を表示します。  下にスクロールして、コンプライアンス態勢の状態、"**データを把握する**" に関連する情報などを確認します。
