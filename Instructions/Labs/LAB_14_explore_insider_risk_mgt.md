...
1. [アクセス許可とロール] ページのコンプライアンス ポータルで、 **[ロール]** を選択します。
...
1. Microsoft Purview コンプライアンス ポータルのホーム ページが表示されているはずです。 そうでない場合は、ブラウザー タブ「**ホーム - Microsoft 365 ライアンス**」を開きます。
