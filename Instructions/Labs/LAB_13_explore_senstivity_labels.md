...
lab:
  ...
  description: このラボでは、機密ラベルの機能の詳細を確認します。 作成された既存の機密ラベルの設定と、ラベルを公開するための対応するポリシーの設定を行います。 次に、ユーザーの観点から、ラベルを適用し、ラベルが適用されたことを検証します。
  duration: 15 minutes
  level: 200
  islab: true
  primarytopics:
...
このラボでは、機密ラベルの機能の詳細を確認します。  作成された既存の機密ラベルの設定と、ラベルを公開するための対応するポリシーの設定を行います。
...
1. 暗号化された秘密度ラベルが適用され、OneDrive と SharePoint に保存されている Office オンライン ファイルのコンテンツを処理する機能が組織で有効になっていないことを示す黄色のバナーが表示されることがあります。 バナーが表示されている場合は、メッセージを確認し、**[今すぐ有効にする]** を選択します。 バナーが表示されていない場合は、次の手順に進みます。

1. 便宜上、一部のラベルは Microsoft 365 ラボ テナントで事前に構成されています。 **[極秘]** という名前のラベルを選択します。 このラベルに関する情報を表示するウィンドウが開きます。  このラベルの設定に注意してください。  このオプションが表示されない場合は、**[ラベルの編集]** を選択し、省略記号を選択します。
...
1. 左側のナビゲーション ウィンドウで、**[ポリシー]** を展開し、**[ラベル発行ポリシー]** を選択します。  機密ラベルを公開できるのは、ラベル ポリシーを通じてです。  便宜上、Microsoft 365 テナントにはいくつかのラベル ポリシーが構成されています。 **[極秘ポリシー]** を選択します。  このポリシーに関する情報を表示するウィンドウが開きます。 ウィンドウの上部にある **[ポリシーの編集]** を選びます。  ここでは、何も変更せずに設定を確認します。
    ...
    1. 会議と予定表イベントの既定の設定: オプションを確認し、Teams の会議と成果物の間で継承を適用するオプションを確認します。 設定を変更しないでください。  [**次へ**] を選択します。
...
このラボでは、既存の秘密度ラベルの設定と、ラベルを発行するための対応するポリシーについて確認しました。
